    ...
    <div class="container  homepage">
        ...
        <div class="row">
            <div class="col-md-12 bgcolorcolmd12pro text-center">
                <h2 class="display-4 font-weight-bold mt-2">Galaxy S</h2>
            </div>
            <div class="row dinhdangcontro">
                <div class="col-md-4">
                    <div class="card ">
                        <img src="img/dien-thoai-galaxy-s21-ultra.jpg" class="card-img-top img-fluid" alt="">
                        <div class="card-body khungcardbody">
                            ...
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">Samsung Galaxy S21
                                    Ultra
                                    5G (12GB|128GB)</a></h5>
                            <h5 style="color: red;">23.590.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>30.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>6.897.000<sup><ins>đ</ins></sup></span>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="card ">
                        <img src="img/dien-thoai-galaxy-s21-ultra.jpg" class="card-img-top img-fluid"
                            alt="iphone-12-pro-128gb-didongviet">
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 7,200,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">Samsung Galaxy S21
                                    Ultra
                                    5G (12GB|256GB)</a></h5>
                            <h5 style="color: red;">26.790.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>33.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>8.037.000<sup><ins>đ</ins></sup></span>
                            </div>
                            <a href="#" class="btn btn-success ">Đặt mua</a>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card ">
                        ...
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 10,400,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">Samsung Galaxy S21
                                    Ultra
                            ...
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>7.077.000<sup><ins>đ</ins></sup></span>
                            </div>
                            <a href="#" class="btn btn-success ">Đặt mua</a>
                        </div>
                    </div>
            ...
            <div class="row dinhdangcontro">
                <div class="col-md-4">
                    <div class="card ">
                        <img src="img/samsung-galaxy-s21-plus-8gb-256gb_1.jpg" class="card-img-top img-fluid"
                            alt="iphone-12-pro-128gb-didongviet">
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 6,600,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">Samsung Galaxy S21
                                    Plus
                                    5G (8GB|256GB)</a></h5>
                            <h5 style="color: red;">22.390.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>28.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>6.717.000<sup><ins>đ</ins></sup></span>
                            </div>
                            <a href="#" class="btn btn-success ">Đặt mua</a>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card ">
                        ...
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">Giảm 7,000,000đ</p>
                                <img class="sticker" src="img/discount-3228141-2697227.png" />
                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">Samsung Galaxy S21
                                    Plus
                                    5G (8GB|128GB)</a></h5>
                            <h5 style="color: red;">18.990.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>25.990.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>5.697.000<sup><ins>đ</ins></sup></span>
                            </div>
                            <a href="#" class="btn btn-success ">Đặt mua</a>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card ">
                        ...
                        <div class="card-body khungcardbody">
                            <span class="sales">
                                <p class="salestex">SMARTPAY GIẢM THÊM 200k</p>

                            </span>
                            <h5 class="card-title text-primary "><a class="doimaumose" href="#">Samsung Galaxy S21
                                    Plus
                                    5G (12GB|256GB)</a></h5>
                            <h5 style="color: red;">18.590.000 <sup><ins>đ</ins></sup></h5>
                            <p><s>18.690.000</s><sup><ins>đ</ins></sup></p>
                            <div class="tratruoc">
                                <label>Trả trước</span></label><br />
                                <span>5.577.000<sup><ins>đ</ins></sup></span>
                            </div>
                            <a href="#" class="btn btn-success ">Đặt mua</a>
                        </div>
                    </div>
